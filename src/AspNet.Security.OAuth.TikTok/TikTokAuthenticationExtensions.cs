...
using System;
using AspNet.Security.OAuth.TikTok;
...
{
    /// <summary>
    /// Extension methods to add TikTok authentication capabilities to an HTTP application pipeline.
    /// </summary>
    public static class TikTokAuthenticationExtensions
    {
        /// <summary>
        /// Adds <see cref="TikTokAuthenticationHandler"/> to the specified
        /// <see cref="AuthenticationBuilder"/>, which enables TikTok authentication capabilities.
        /// </summary>
        /// <param name="builder">The authentication builder.</param>
        /// <returns>A reference to this instance after the operation has completed.</returns>
        public static AuthenticationBuilder AddTikTok([NotNull] this AuthenticationBuilder builder)
        {
            return builder.AddTikTok(TikTokAuthenticationDefaults.AuthenticationScheme, options => { });
        }
        ...
        /// <param name="configuration">The delegate used to configure the TikTok options.</param>
